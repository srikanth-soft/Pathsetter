...
const TrackUser = () => {
  ...
  return (
    <div>
      <div
        ref={containerRef}
        className={`grid mt-10  md:grid-cols-2 gap-10 p-5 md:p-10 max-w-[1440px] m-auto mb-10 border-[#1e253f] border-[0.2px] rounded-lg relative overflow-hidden track-radial-gradient`}
      >
        <div
          className={`border-[#1e253f] border-[0.2px] rounded-lg p-5 md:p-10 text-white opacity-0 ${
        ...
        <div className={`opacity-0 ${isVisible ? "track-left-in" : ""} `}>
          ...
          <p className="text-center md:text-left text-[50px] font-medium text-white">
            <span className="gradient-text bg-gradient-to-br from-green-400 via-blue-600 to-purple-600 text-transparent bg-clip-text">
              Track user activity and control access.
            </span>
          </p>
          <p className="text-[#5e6374]">
            Access <span className="text-[#535a8a]">valuable insights</span>{" "}
